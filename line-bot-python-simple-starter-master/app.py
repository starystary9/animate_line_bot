...
from modules.comic_update import comic_update
...
CHANNEL_ACCESS_TOKEN = '/kdyRNDo7yqsstfu5KL0UOiGyZsRMbqvxYqaJgw/OEN25xjHonqXYLlIbSmpFMLRrkaV2wtBINcOH0kcokNpHBbMhGTGwqTTkCLVqRrm6tG24roKAx1xdCc+m47KUHoEGB1YIvEJUrSccDqXH3NJlwdB04t89/1O/w1cDnyilFU='
CHANNEL_SECRET = '21b5981d4f2c07c3faa28e4b9746f05a'
...
def handle_message(event):
    ...
    if user_msg in faq:
        reply = faq[user_msg]
    elif user_msg in comic_update:
        reply = TextSendMessage(f"date:{comic_update[user_msg]['date']}\nlatest chapetr:{comic_update[user_msg]['latest chapter']}\nlink: {comic_update[user_msg]['link']}")
    else:
        reply = menu
